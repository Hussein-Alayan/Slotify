...
use App\Http\Requests\TestBookingFlowRequest;
...
class TestBookingController extends Controller
{
    ...
    /**
     * Test the complete booking flow with AI integration
     */
    public function testBookingFlow(TestBookingFlowRequest $request)
    {
        $flowSteps = [];
